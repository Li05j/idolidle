...
function stat_base(stat: BasicStats): DreamUpgradeDef {
    return {
        ...
        name: `${stat} Base`,
        desc: `+3.0 initial ${stat} base per level`,
        max_level: 25,
...
function stat_multi(stat: BasicStats): DreamUpgradeDef {
    return {
        ...
        name: `${stat} Multi`,
        desc: `+0.03 initial ${stat} multiplier per level`,
        max_level: 25,
...
export const ALL_DREAM_UPGRADES: DreamUpgradeDef[] = [
    // Time reductions
    {
        id: 'time_location',
        name: 'Swift Travel',
        desc: 'Reduce location card base time by 2% per level',
        max_level: 25,
    ...
    },
    {
        id: 'time_training',
        name: 'Quick Training',
        desc: 'Reduce training card base time by 2% per level',
        max_level: 25,
        effect_per_level: 0.02,
        base_cost: 3,
        category: 'time_reduction',
    },
    {
        id: 'time_earning',
        name: 'Efficient Work',
        desc: 'Reduce earning/spending card base time by 2% per level',
        max_level: 25,
        effect_per_level: 0.02,
        base_cost: 3,
        category: 'time_reduction',
