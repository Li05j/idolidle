...
import { type TodoBase } from './todo_type';
    ...
    ["School", 
        [
                ...
                },
                {
                    ...
                    extra_reward_fn: () => {
                        ...
                        if (stat < 1/6) {
                            ...
                            history.addEurekaLogs(`+${actual_gain} Stamina`, `The Grade Report has enlightened you.`)
                        } else if (stat < 1/3) {
                            let actual_gain = Math.floor(gain * stat_list.Haste.multi)
                            stat_list.Haste.base += gain
                            history.addEurekaLogs(`+${actual_gain} Haste`, `The Grade Report has enlightened you.`)
                        } else if (stat < 1/2) {
                            let actual_gain = Math.floor(gain * stat_list.Sing.multi)
                            stat_list.Sing.base += gain
                            history.addEurekaLogs(`+${actual_gain} Sing`, `The Grade Report has enlightened you.`)
                        } else if (stat < 2/3) {
                            let actual_gain = Math.floor(gain * stat_list.Dance.multi)
                            stat_list.Dance.base += gain
                            history.addEurekaLogs(`+${actual_gain} Dance`, `The Grade Report has enlightened you.`)
                        } else if (stat < 5/6) {
                            let actual_gain = Math.floor(gain * stat_list.Charm.multi)
                            stat_list.Charm.base += gain
                            history.addEurekaLogs(`+${actual_gain} Charm`, `The Grade Report has enlightened you.`)
                        } else if (stat <= 1) {
                            let actual_gain = Math.floor(gain * stat_list.Presence.multi)
                            stat_list.Presence.base += gain
                            history.addEurekaLogs(`+${actual_gain} Presence`, `The Grade Report has enlightened you.`)
                        }
                    },
                },
            ),
            new ActionTodo(
                ...
                },
                {
                    extra_reward_fn: () => {
                        ...
                        if (a < 0.5) {
                            stat_list.Sing.base += gain
                            history.addEurekaLogs(`+${(gain * stat_list.Sing.multi).toFixed(DECIMAL_PLACES)} Sing`)
                        }
                        if (b < 0.5) {
                            stat_list.Dance.base += gain
                            history.addEurekaLogs(`+${(gain * stat_list.Dance.multi).toFixed(DECIMAL_PLACES)} Dance`)
                        }
                        if (c < 0.5) {
                            stat_list.Charm.base += gain
                            history.addEurekaLogs(`+${(gain * stat_list.Charm.multi).toFixed(DECIMAL_PLACES)} Charm`)
                        }
                        if (d < 0.5) {
                            stat_list.Presence.base += gain
                            history.addEurekaLogs(`+${(gain * stat_list.Presence.multi).toFixed(DECIMAL_PLACES)} Presence`)
                        }
                    },
                },
            ),
                ...
                },
                {
                    extra_reward_fn: () => {
                        ...
                        if (r < 0.1) {
                            ...
                            let actual_gain = Math.floor(gain * stat_list.Fans.multi)
                            stat_list.Fans.base += gain
                            history.addEurekaLogs(`+${actual_gain} Fans`, `You attracted ${actual_gain} student(s) to be fans!`)
                        }
                    },
                },
            ),
            ...
            new ActionTodo(
                'Climbing the Stairs',
                20 * S_TO_MS,
                [{ which_stat: "Haste", effectiveness: 1.0 },],
                ...
                },
                {
                    extra_reward_fn: () => {
                        ...
                        if (r < 0.1) {
                            ...
                            stat_list.Fans.base += gain
                            history.addEurekaLogs(`+${Math.floor(gain * stat_list.Fans.multi)} Fans`, 'The concert was a BIG SUCCESS!')
                        }
                    },
                    check_disabled_fn: (stat_list) => {
                ...
                },
                {
                    extra_reward_fn: () => {
                        ...
                        if (r < 0.1) {
                            ...
                            history.addEurekaLogs(`+0.01 Fans multi`, `You sparked interest among students!`)
                        }
                    },
                },
            ),
    ...
    ["Gym", 
        [
            ...
            new SpendCurrencyTodo(
                ...
                Cost.gym_actions,
                [
                    { which_stat: "Haste", flat_gain_base: 3 },
                ],
    ...
    ["Gym VIP", 
        [
            new ActionTodo(
                ...
                [
                    { which_stat: "Haste", flat_gain_base: 3.0 },
                ],
                "Running.",
                {
                    dependsOn: "Stamina",
                    eureka: "Slight chance to gain 0.01 Haste multi"
                },
                {
                    extra_reward_fn: () => {
                        let r = Math.random();
                        if (r < 0.1) {
                            stat_list.Haste.multi += 0.01
                            history.addEurekaLogs(`+0.01 Haste multi`, 'An unexpected breakthrough!')
                        }
                    },
                }
            ),
            new ActionTodo(
                ...
                [
                    { which_stat: "Stamina", effectiveness: 0.5 },
                    { which_stat: "Haste", effectiveness: 0.5 },
                ],
                [
                ...
                },
                {
                    extra_reward_fn: () => {
                        ...
                        if (r < 0.1) {
                            ...
                            history.addEurekaLogs(`+0.01 Stamina multi`, 'An unexpected breakthrough!')
                        }
                    },
                }
            ),
                ...
                },
                {
                    extra_reward_fn: () => {
                        ...
                        if (r < 0.1) {
                            ...
                            history.addEurekaLogs(`+0.01 Charm multi`, 'An unexpected breakthrough!')
                        }
                    },
                },
            ),
            ...
            new ActionTodo(
                ...
                },
                {
                    ...
                    extra_reward_fn: () => {
                        ...
                        history.addEurekaLogs(`+${Math.floor(gain * stat_list.Moni.multi)} Moni`, 'Free Moni~')
                    },
                },
            ),
            new GainCurrencyTodo(
                ...
                },
                {
                    extra_reward_fn: () => {
                        ...
                        if (r < 0.5) {
                            ...
                            let actual_gain = Math.floor(gain * stat_list.Fans.multi)
                            stat_list.Fans.base += gain
                            history.addEurekaLogs(`+${actual_gain} Fans`, `You converted ${actual_gain} Otaku(s) into fans!`)
                        }
                    },
                },
            ),
