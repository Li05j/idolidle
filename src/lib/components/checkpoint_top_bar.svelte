<script lang="ts">
    ...
    let progress_text = $derived(`${Math.round(progress)}% complete`);
...
<div class="bg-white p-6 rounded-lg shadow-md mb-4 top-0 left-0 w-full">
    <div class="flex justify-between items-center mb-4">
        ...
        <div class="text-gray-600 text-sm">{checkpoint.current_time_spent}/{checkpoint.current_total_time}s</div>
    </div>
