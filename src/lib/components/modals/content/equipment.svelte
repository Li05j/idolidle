<script lang="ts">
    ...
    import { EquipmentPanelVM } from './equipment_panel.svelte';
...
<div class="flex flex-col h-[70vh] gap-2">
    ...
    <div class="flex gap-2 h-[58%] min-h-0">
        ...
        <!-- Inventory List -->
        <div class="w-2/3 rounded-xl bg-[var(--surface-inset)] p-3 overflow-y-auto">
            <div class="text-xs font-bold text-[var(--text-muted)] uppercase tracking-wide mb-2">Inventory</div>
    ...
    <div class="flex-1 min-h-0 rounded-xl bg-[var(--surface-inset)] p-4 overflow-y-auto">
        {#if vm.selected_item && vm.selected_def}
            <!-- Item Detail View -->
